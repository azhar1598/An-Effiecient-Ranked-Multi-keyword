...
.style35 {font-size: 20px; color: #000000; }
  ...
  <div class="tail-bottom">
	...
	try 
	{
		String msg="";
			...
			{
				%>
                  <h3 class="style33 style34 style36">File Deleted Sucessfully !!</h3>
                  <a href="E_Delete.jsp">Back</a><br />
                  <%
			}
			else
			{
				%>
                  <h3 class="style35">File Not Found !!</h3>
                  <a href="E_Delete.jsp">Back</a><br />
                  <%
			}
	}
