            ...
            <div class="col-1">
              <div class="indent">
                <div class="indent1">
                  <h3>Search Files ..... </h3>
                  <p align="justify">&nbsp;</p>
                  <form id="form1" method="post" action="R_Search1.jsp">
                    <p>&nbsp;</p>
                    <table width="487" border="0" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
                      <tr>
                        <th width="236" height="40" bgcolor="#FF0000" scope="row"><div align="left"><span class="style15"><span class="odd  style16">Enter Multi Keyword To Search : </span></span></div></th>
