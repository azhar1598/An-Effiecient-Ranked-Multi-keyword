                ...
                <div class="indent1">
                  ...
                  <table width="763" border="2" cellpadding="0" style="border-collapse:collapse" cellspacing="0" align="center">
                    <tr>
                      ...
                      <td width="154" bgcolor="#FF0000"><div align="center" class="style24">User Name </div></td>
                      <td width="146" bgcolor="#FF0000"><div align="center" class="style24">File Name </div></td>
	...
	while ( rs1.next() )
	   {
		s2=rs1.getString(2);
      		...
      		String query="select * from Transaction where fname='"+s2+"' "; 
...
%>
                  ...
                  <table width="750" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <th scope="row"><div align="right"><a href="E_Main.jsp">Back</a></div></th>
                    </tr>
                  </table>
                </div>
                </div>
