...
<%
					...
					try {
						...
						//image = image.replace(".", "_b.");
			 			String query1="select * from dataowner  where name='"+uname+"'"; 
					...
					if ( rs1.next() )
					   {
								...
								out.println("Encryptor Name Already Exits");							
							%>
							<p><a href="E_Login.jsp">Back</a>         <a href="index.html">Home</a> </p>
					   ...
					   {
					PreparedStatement ps=connection.prepareStatement("insert into dataowner(name,pass,email,mobile,addr,dob,gender,pin,location,imagess,status) values(?,?,?,?,?,?,?,?,?,?,?)");
