            ...
            <div class="col-1">
              <div class="indent">
                <div class="indent1">
                  ...
                  <p>&nbsp;</p>
                  <table width="546" border="2" style="border-collapse:collapse" cellpadding="0" cellspacing="0"  align="center">
                    <%	  
...
try 
	{		
				%>
                    <tr>
                      <td width="48" height="30" bgcolor="#FF0000"><div align="center" class="style25 style26"> ID </div></td>
                      <td width="136" bgcolor="#FF0000"><div align="center" class="style27">File Name </div></td>
                      <td width="208" bgcolor="#FF0000"><div align="center" class="style27">Date &amp; Time </div></td>
                      <td width="142" bgcolor="#FF0000"><div align="center" class="style27">Data Owner </div></td>
                    </tr>
                    <%
