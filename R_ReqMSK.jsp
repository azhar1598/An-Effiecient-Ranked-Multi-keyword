            ...
            <div class="col-1">
              <div class="indent">
                <div class="indent1">
                  ...
                  <form action="R_ReqMSK1.jsp" method="post" id="leavereply">
                    <div align="center">
                      <p align="left" class="style17">&nbsp;</p>
                      <p align="left" class="style17">&nbsp;</p>
                      <p align="left" class="style18">Enter Encryptor Name : &nbsp;
                          <input name="t142" type="text" size="30" />
                                            </p>
                      <p align="left" class="style17"><span class="style19"> Enter File Name :&nbsp;&nbsp; </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <div align="right"><a href="R_Main.jsp">Back</a>                    </div>
                  </form>
                  </div>
                </div>
            </div>
