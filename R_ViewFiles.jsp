...
.style26 {font-size: 14px; color: #FFFF00; font-weight: bold; }
-->
</style>
</head>
<body id="page1">
            ...
            <div class="col-1">
              <div class="indent">
                <div class="indent1">
                  <h3>View Files</h3>
                  <p align="justify">&nbsp;</p>
                  <table width="480" border="1.5" style="border-collapse:collapse" cellpadding="0" cellspacing="0"  align="center">
                    <%	  
...
try 
	{		
				%>
                    <tr>
                      <td width="42" height="30" bgcolor="#FF0000"><div align="center" class="style26"> ID </div></td>
                      <td width="134" bgcolor="#FF0000"><div align="center" class="style26">File Name </div></td>
                      <td width="133" bgcolor="#FF0000"><div align="center" class="style26">Data Owner  </div></td>
                      <td width="161" bgcolor="#FF0000"><div align="center" class="style26">Date &amp; Time</div></td>
                    </tr>
                    <%
...
%>
                  ...
                  <p align="justify">&nbsp;</p>
                  <p align="right"><a href="R_Main.jsp">Back</a></p>
                </div>
                <h4>&nbsp;</h4>
              </div>
            </div>
