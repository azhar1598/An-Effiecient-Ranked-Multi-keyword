      ...
      <div id="header">
        ...
        <div class="row-2">
          <ul>
            ...
            <li class="m2"><a href="R_Login.jsp">End users </a></li>
            <li class="m3"><a href="E_Login.jsp">Data Owner</a></li>
            <li class="m5"><a href="C_Login.jsp" class="active">Cloud server </a></li>
          </ul>
        </div>
        <div class="row-3">
        ...
        <div class="tail-right">
          <div class="wrapper">
            <div class="col-1">
              <div class="indent">
                <div class="indent1">
                  <h3>Cloud Server Login </h3>
                  <form action="C_Authentication.jsp" method="post" id="leavereply">
                    <label for="name"><img src="images/Login.jpg" alt="" width="293" height="159" /><br />
                    <br />
