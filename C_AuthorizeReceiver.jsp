...
.style28 {font-size: 14px; color: #FFFF00; font-weight: bold; }
              ...
              <div class="indent">
                <div class="indent1">
                  ...
                  <table width="500" border="1.5" cellpadding="0" cellspacing="0"  align="center">
                    <tr>
                      <td width="108" height="30" bgcolor="#FF0000"><div align="center" class="style21 style27"> ID </div></td>
                      <td width="183" bgcolor="#FF0000"><div align="center" class="style28"> Name </div></td>
                      <td width="171" bgcolor="#FF0000"><div align="center" class="style28"> Status </div></td>
                      <%	  
	...
	while ( rs.next() )
	   {
		...
		%>
                    ...
                    <tr>
                      <td height="28" bgcolor="#F0F0F0"><div align="center" class="style30"><%=i%></div></td>
                      <td bgcolor="#F0F0F0"><div align="center" class="style30"><a href="C_UserDetails.jsp?name=<%=s2%>"><%=s2%></a></div></td>
                      <%	
			if(s5.equalsIgnoreCase("Waiting"))
			{
			
		%>
                      <td bgcolor="#F0F0F0"><div class="style30">
			...
			{
		%>
                      <td width="28" bgcolor="#F0F0F0"><div class="style30">
